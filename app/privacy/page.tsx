export const metadata = { title: "سياسة الخصوصية | ون هايد بارك التجمع الخامس" };
  ...
  return (
    <main className="min-h-screen bg-bone text-ink/80">
      <div className="mx-auto max-w-3xl px-4 py-16 leading-relaxed space-y-5">
        ...
        <p>الاسم، رقم الهاتف وكود الدولة، ونوع الوحدة محل الاهتمام. كما نستخدم ملفات تعريف الارتباط (Cookies) وأدوات قياس مثل Google Ads لقياس أداء الحملات الإعلانية وتحسين تجربة التصفح.</p>
        ...
        <p>يحق لك طلب حذف بياناتك أو إيقاف التواصل في أي وقت عبر الاتصال على <span dir="ltr">01001050018</span> أو مراسلتنا واتساب.</p>
